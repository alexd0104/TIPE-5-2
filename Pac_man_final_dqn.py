...
def game_reset():
    ...
    return Coord, Gomme, tour, points, peur, peurs, killstreak, catch, vie, done
...
def respawn(Gomme,tour,peur,peurs,vie):
    if vie == 1 : 
        ...
        return Coord, Gomme, tour, points, peur, peurs, killstreak, catch, vie-1, False
...
def take_action(dp,va_jeu):
    Coord, Gomme, tour, points, peur, peurs, killstreak, catch, vie, done =va_jeu
    lastd=Coord[0][1]
    ...
    va_jeu = Coord, Gomme, tour, points, peur, peurs, killstreak, catch, vie, False 
    return va_jeu
